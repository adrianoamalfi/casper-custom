...
- Theme validation: `pnpm test` (gscan) before every PR
- CI gate: `pnpm test:ci` must pass with zero fatal errors
- Always run `pnpm zip` before any gscan validation (pretest hook handles this)
